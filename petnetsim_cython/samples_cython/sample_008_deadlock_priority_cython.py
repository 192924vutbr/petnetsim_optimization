...
def run():
    ...
    resource_places = [pns.Place('R1', 1), pns.Place('R2', 1)]
    process_states = [pns.Place(p+'CriticalSectionIn', 1) for p in ['P1', 'P2']] + \
                     ['P1HaveR1', 'P2HaveR2'] + \
    ...
    transitions = [p+s for p, s in itertools.product(['P1', 'P2'], ['Release'])] + \
                  [pns.TransitionPriority('P1AcquireR1', 1), pns.TransitionPriority('P2AcquireR2', 1), pns.TransitionPriority('P1AcquireR2', 1), pns.TransitionPriority('P2AcquireR1', 1),
    ...
    petri_net = pns.PetriNet(resource_places+process_states,
                         transitions,
                         arcs)
