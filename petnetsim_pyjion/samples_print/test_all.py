...
from petnetsim_pyjion.samples_print import sample_001_basic_edit, sample_002_conflict_groups,sample_003_inhibitors_edit, sample_004_stochastic, sample_005_priority, sample_006_timed, sample_007_deadlock, sample_008_deadlock_priority, sample_009_deadlock_P1watchdog, sample_010_capacity_limit_shared_output, sample_011_json, sample_012_netclone
import time
import numpy as np
import pyjion
pyjion.enable()
...
while i < cyc_num:
    ...
    Time_003.append(time.perf_counter() - start_time)
    i = i + 1
i=1
Time_004 = []
while i < cyc_num:
    ...
    Time_004.append(time.perf_counter() - start_time)
    i = i + 1
i=1
Time_005 = []
while i < cyc_num:
    ...
    Time_005.append(time.perf_counter() - start_time)
    i = i + 1
i=1
Time_006 = []
while i < cyc_num:
    ...
    Time_006.append(time.perf_counter() - start_time)
    i = i + 1
i=1
Time_007 = []
while i < cyc_num:
    ...
    Time_007.append(time.perf_counter() - start_time)
    i = i + 1
i=1
Time_008 = []
while i < cyc_num:
    ...
    Time_008.append(time.perf_counter() - start_time)
    i = i + 1
i=1
Time_009 = []
while i < cyc_num:
    ...
    Time_009.append(time.perf_counter() - start_time)
    i = i + 1
i=1
Time_010 = []
while i < cyc_num:
    ...
    Time_010.append(time.perf_counter() - start_time)
    i = i + 1
...
while i < cyc_num:
    ...
    sample_011_json.run()
    Time_011.append(time.perf_counter() - start_time)
    i = i + 1
...
while i < cyc_num:
    ...
    Time_012.append(time.perf_counter() - start_time)
    i = i + 1
