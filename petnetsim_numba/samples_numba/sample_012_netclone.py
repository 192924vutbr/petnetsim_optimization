from petnetsim_numba import PetriNet, Place, Transition, new_context
import petnetsim_numba.json_io


def run():
    subnet_ctx = new_context()
    with open('sample_012_netclone.json') as f:
        sn_places, sn_transitions, sn_arcs, sn_graphics = petnetsim_numba.json_io.load(f, subnet_ctx)
